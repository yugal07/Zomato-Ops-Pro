          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="relative" ref={profileDropdownRef}>
              <button
                ...
                className="flex items-center space-x-3 text-sm rounded-lg hover:bg-gray-50 p-2 transition-all focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
            ...
            <button
              ...
              className="md:hidden p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-50 rounded-lg transition-all"
            >
              {isMobileMenuOpen ? (
                <X className="h-5 w-5" />
              ) : (
